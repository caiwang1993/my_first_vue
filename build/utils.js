'use strict'
//此文件主要生成css loader和style loader的一些方法

//引入node.js的path模块，用于操作路径
const path = require('path')
//引入模板的配置文件，下面就需要去这个文件看看有什么基本配置
const config = require('../config')
//提取特定文件的插件，比如把css文件提取到一个文件中
...
//path.posix是path模块跨平台的实现（不同平台的路径表示是不一样是）
...
exports.cssLoaders = function (options) {
  ...
  return {
    ...
    // stylus-loader stylus文件有两种后缀名.stylus和sty
